...
-- -- server supports gradle and maven as build tools. Your project should either have a
-- -- pom.xml or settings.gradle and build.gradle file to declare the dependencies.
